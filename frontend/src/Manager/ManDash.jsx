...
function ManDash() {
  ...
  return (
   ...
   <div className="container">
      <div className="row mt-4 shadow-lg rounded-4 bg-white px-3">
                  ...
                  <div className="row g-4 align-items-start">
                    <div className="col-12 col-md-6">
                      <p className="text-muted mb-2">
                        Welcome, <span className="fw-bold text-dark">Mr. Manager</span>
                      </p>
                      <h6 className="text-muted mb-1">Overview</h6>
                      <h2 className="fw-bold mb-4">
                        25 <span className="fs-5 fw-normal text-muted">enquiries</span>
                      </h2>
                    </div>
                  ...
                  <div className="row gap-4 mt-1">
                    ...
                    <div className="col-4 col-sm-6 col-xl-3 shadow-lg p-3 rounded-4" style={{width: "14vw"}}>
                      <div className="mini-stat-card">
                        <p className="text-muted mb-2">Workshop students</p>
                        <h2 className="fw-bold mb-1">0</h2>
                    ...
                    <div className="col-12 col-sm-6 col-xl-3 shadow-lg p-3 rounded-4" style={{width: "14vw"}}>
                      <div className="mini-stat-card">
                        ...
                        <h2 className="fw-bold mb-1">4</h2>
